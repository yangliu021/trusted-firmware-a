...
/*
    Register : APSS_QTMR0_F2V1_QTMR_V1_CNTP_CVAL_LO - Higher [23:0] bytes to set QTimer count
*/
...
/*
    Register : APSS_QTMR0_F3V1_QTMR_V1_CNTP_CVAL_LO - Higher [23:0] bytes to set QTimer count
*/
...
/*
    Register : APSS_QTMR0_F4V1_QTMR_V1_CNTP_CVAL_LO - Higher [23:0] bytes to set QTimer count
*/
...
/*
    Register : APSS_QTMR0_F5V1_QTMR_V1_CNTP_CVAL_LO - Higher [23:0] bytes to set QTimer count
*/
...
/*
    Register : APSS_QTMR0_QTMR_AC_CNTFRQ, address offset to configure Qtimer counter frequency
*/
#define APSS_QTMR_AC_CNTFRQ_RMSK 0xffffffff
#define APSS_QTMR_AC_CNTFRQ_ADDR_OFFSET 0x00000000

/*
    Register : APSS_QTMR0_QTMR_AC_CNTNSAR_FG0, address offset to configure Qtimer Counter Secure Reg to allow QTMR access
...
/*
    Register : APSS_QTMR0_QTMR_AC_CNTACRn_FG0, n=[0..6], address offset for configuring Qtimer global access
...
/*
    Register : APSS_QTMR0_QTMR_AC_CNTVOFF_FG0_LO_n & APSS_QTMR0_QTMR_AC_CNTVOFF_FG0_HI_n address offsets
*/
